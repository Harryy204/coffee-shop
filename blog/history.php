...
<body>
    ...
    <img src="../images/history.jpg" alt="Lịch sử" style="width:100%">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title">NGUỒN GỐC</h1>
                        <p class="card-text">
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="../images/history.jpg" class="card-img-top card-img" style="height: 500px;">
                </div>
            </div>
        </div>
    </div>
